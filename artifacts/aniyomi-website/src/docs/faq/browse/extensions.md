...
Watchtower is bring-your-own-content and does not offer anything.

::: info Disclaimer
**Watchtower** isn't responsible for slow, down, missing chapters/episodes, or subpar image/video quality of sources as it doesn't host content.
:::
...
Uninstall extensions like regular apps: through device settings or in **Watchtower**.

::: tip Uninstalling an extension
In **Watchtower**, uninstall an extension via <nav to="extensions">, then tap **Uninstall** on the chosen extension.
:::
