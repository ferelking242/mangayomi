...
What it does do is allow users of Watchtower to visually plot their upcoming smart updates, as well as get a feel for when new chapters/episodes are *expected* to be released.

## What are Smart Updates?
In order to reduce strain on sources and save user bandwidth, Watchtower tries to estimate when chapter/episode updates will be available, and only once that time has passed, include that series in automatic updates.
