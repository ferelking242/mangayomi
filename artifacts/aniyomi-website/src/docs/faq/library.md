...
This strategy prevents unnecessary load which may lead to sources implementing measures against **Watchtower**.
...
Excessive server load may trigger anti-**Watchtower** measures from sources. See the previous question for more context. Long-running update checks and downloads may also impact your device's battery life.
...
Whitelist **Watchtower** from your battery saver by going to <nav to="advanced"> and tapping **Disable battery optimization**.
...
**Watchtower** can't sync between devices.
...
**Watchtower** detects these changes and interprets the episodes as new.
