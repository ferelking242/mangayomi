...
Here, additional messages such as the [Autoplay](/docs/guides/video-player/#autoplay) status, current [View mode](/docs/guides/video-player/#cycle-view-mode), and [`watchtower.show_text(text)`](/docs/guides/player-settings/custom-buttons#watchtower-show-text-text) shows up.
