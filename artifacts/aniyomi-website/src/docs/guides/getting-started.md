...
description: Essential information to help you get set up with Watchtower.
---
...
### Downloading Watchtower

1. Visit our [download](/download/) page to get the latest version of **Watchtower**.
2. After the download is complete, open the `.apk` file.
3. Proceed with the installation process.

::: tip Android requirement
Watchtower requires **Android 6.0 (Marshmallow)** or higher.
:::

### Adding sources

Once **Watchtower** is installed on your device, you can bring your own content from various sources:
...
::: danger Caution
Watchtower will not provide resources for any unofficial repositories. Beware that any third-party repositories or extensions will have full access to the app and may contain malware.
:::
...
::: danger Caution
Watchtower will not provide resources for any unofficial extensions. Beware that any third-party repositories or extensions will have full access to the app and may contain malware.
:::
::::
