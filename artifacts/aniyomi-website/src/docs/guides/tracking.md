...
- Tracking is one-way: **Watchtower -> Tracker**.
...
If you cannot find a series by name, you can look it up on MyAnimeList and then search for it in **Watchtower** using the following format: `id:<id from series URL>`.
