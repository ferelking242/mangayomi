...
description: Using Shizuku with Watchtower.
---

# Shizuku
**Shizuku** is an alternative method for installing and updating extensions in **Watchtower**.
...
After configuring it, enable **Shizuku** within **Watchtower** by navigating to <nav to="advanced"> then changing the **Installer** setting.
