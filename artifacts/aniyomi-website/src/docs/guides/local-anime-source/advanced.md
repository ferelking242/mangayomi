...
```
::: tip
If you don't want to create the `details.json` file manually, you can use [this website](https://watchtower-local.netlify.app)
:::
...
As Watchtower will use the `episode_number` key to match the episodes, the order of the JSON objects in the list does not matter.
:::
