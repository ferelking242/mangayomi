...
* Else, delete **Watchtower** downloads folder on SD card.

### Storage issues with Android 11+
See [this](/docs/faq/storage) section of the FAQ to learn how Scoped Storage affects **Watchtower** in **Android 11+** and how to fix it.
...
* Grant **Watchtower** SD card access in Android settings.
