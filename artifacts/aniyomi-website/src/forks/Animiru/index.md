...
title: Animiru
titleTemplate: false
description: Watchtower without the manga features from Mihon - Focused in anime.
...
hero:
  name: Animiru
  text: Anime-only
  tagline: Watchtower without the manga features from Mihon - Focused in anime.
