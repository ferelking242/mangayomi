...
// ──────────────────────────────────────────────────────────────
// Archive format — persisted via DownloadSettingsService
// ──────────────────────────────────────────────────────────────

@riverpod
class ArchiveFormatState extends _$ArchiveFormatState {
  @override
  ArchiveFormat build() {
    DownloadSettingsService.instance.load();
    return DownloadSettingsService.instance.archiveFormat;
  }

  Future<void> set(ArchiveFormat fmt) async {
    state = fmt;
    await DownloadSettingsService.instance.setArchiveFormat(fmt);
  }
}
...
@riverpod
class ConcurrentMangaState extends _$ConcurrentMangaState {
  @override
  int build() {
    DownloadSettingsService.instance.load();
    return DownloadSettingsService.instance.concurrentManga;
  }

  Future<void> set(int value) async {
    state = value;
    await DownloadSettingsService.instance.setConcurrentManga(value);
  }
}

@riverpod
class ConcurrentWatchState extends _$ConcurrentWatchState {
  @override
  int build() {
    DownloadSettingsService.instance.load();
    return DownloadSettingsService.instance.concurrentWatch;
  }

  Future<void> set(int value) async {
    state = value;
    await DownloadSettingsService.instance.setConcurrentWatch(value);
  }
}

@riverpod
class ConcurrentNovelState extends _$ConcurrentNovelState {
  @override
  int build() {
    DownloadSettingsService.instance.load();
    return DownloadSettingsService.instance.concurrentNovel;
  }

  Future<void> set(int value) async {
    state = value;
    await DownloadSettingsService.instance.setConcurrentNovel(value);
  }
}
